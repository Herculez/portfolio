                                ...
                                <Col sm={9}>
                                    <Tab.Content>
                                        <Tab.Pane eventKey="first">
                                            ...
                                            <img
                                                src={"/portfolio/assets/Exfiltraitor.PNG"}
                                                alt="Exfiltraitor"
                                                style={{
                                                    maxWidth: "100%",
                                                    cursor: "pointer",
                                                ...
                                                onClick={() =>
                                                    openLightbox([
                                                        { src: "/portfolio/assets/Exfiltraitor.PNG" },
                                                        { src: "/portfolio/assets/CheckpointScene.png" },
                                                    ])
                                                }
                                            />
                                        </Tab.Pane>
                                        ...
                                        <Tab.Pane eventKey="second">
                                            ...
                                            <img
                                                src={"/portfolio/assets/Minecraft3.png"}
                                                alt="Maze"
                                                style={{
                                                    maxWidth: "100%",
                                                    cursor: "pointer",
                                                ...
                                                onClick={() =>
                                                    openLightbox([
                                                        { src: "/portfolio/assets/Minecraft3.png" },
                                                        { src: "/portfolio/assets/Minecraft1.png" },
                                                        { src: "/portfolio/assets/Minecraft2.png" },
                                                        { src: "/portfolio/assets/Minecraft4.png" },
                                                        { src: "/portfolio/assets/Minecraft5.png" },
